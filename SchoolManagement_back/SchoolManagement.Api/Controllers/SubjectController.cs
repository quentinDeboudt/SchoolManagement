...
public class SubjectController : ControllerBase
{
    ...
    // [HttpPost]
    // public Task Create([FromBody] Subject subject)
    // {
    //     _subjectService.CreateAsync(subject);
    ...
    // [HttpGet("search")]
    // public IActionResult SearchSubjects(string term, int pageIndex, int pageSize)
    // {
    //     var result = _subjectService.SearchSubjects(term, pageIndex, pageSize);
    //     return Ok(result);
    // }
}
